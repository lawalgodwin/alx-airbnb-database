...
EXPLAIN SELECT booking_id, created_at, status FROM bookings WHERE created_at = "2024-11-27 00:29:13" AND status = "pending";
...
EXPLAIN SELECT * FROM properties WHERE location = "Miami, FL";
